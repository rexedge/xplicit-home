...
export default function LoungeInventoryPage() {
  ...
  const fetchItems = async () => {
    setIsLoading(true);
    const result = await getInventoryItems("LOUNGE");
    console.log({ result });
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    const result = currentItem
      ...
      : await createInventoryItem({ ...formData, category: "LOUNGE" });
  ...
  return (
    <div className="container mx-auto py-10">
      <div className="flex justify-between items-center mb-6">
        <h1 className="text-3xl font-bold">Lounge Inventory Management</h1>
      ...
      <Dialog open={isDialogOpen} onOpenChange={setIsDialogOpen}>
        <DialogContent>
          <DialogHeader>
            ...
            <DialogDescription>
              {currentItem
                ? "Edit the details of the lounge inventory item."
                : "Enter the details of the new lounge inventory item."}
            </DialogDescription>
          </DialogHeader>
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              <Label>Images</Label>
              <ImageUploader onUpload={handleImageUpload} category="LOUNGE" />
